                        ...
                        <div className="space-y-0.5">
                          {col.links.map((link) => (
                            ...
                            >
                              ...
                              <span className="text-xs font-medium text-slate-300 group-hover:text-white transition-colors leading-tight">{link.name}</span>
                            </Link>
                          ))}
                        </div>
                      </div>
            ...
            {user ? (
              <div className="flex items-center gap-4">
                ...
                <Link
                  ...
                  title="My Profile"
                  className="w-9 h-9 rounded-xl grad-em flex items-center justify-center shadow-md hover:scale-110 transition-transform"
                >
            ...
            <div className="pt-2 space-y-2 border-t border-slate-800 mt-2">
              {user ? (
                <>
                  ...
                  <Link to="/dashboard?tab=profile" className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-slate-800/70 border border-slate-700 text-slate-200 font-semibold text-sm">
                    <span className="w-6 h-6 rounded-lg grad-em flex items-center justify-center text-white font-black text-xs">{user.name.charAt(0)}</span>
                    My Profile
                  </Link>
