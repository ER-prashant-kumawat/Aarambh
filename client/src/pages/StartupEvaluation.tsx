...
import { ClipboardCheck, Loader2, CheckCircle2, AlertCircle, Upload } from 'lucide-react';
...
function SectionHeader({ num, title, points }: { num: string; title: string; points: number }) {
  return (
    <h3 className="text-xs font-bold text-emerald-400 uppercase tracking-widest border-b border-slate-800/80 pb-1 flex items-center justify-between">
      <span>{num}. {title}</span>
      <span className="text-slate-600 normal-case tracking-normal font-medium">{points} pts</span>
    </h3>
  );
}
...
export default function StartupEvaluation() {
  ...
  const handleSubmit = async (ev: React.FormEvent) => {
    ...
    if (!validate()) {
      ...
      const firstError = Object.keys(errors).find((k) => errors[k]) || Object.keys(form).find((k) => !((form as any)[k]));
              ...
              <>
                ...
                <form onSubmit={handleSubmit} className="space-y-8">
                  ...
                  <div className="space-y-4">
                    <SectionHeader num="01" title="Founder Details" points={15} />
                    ...
                    <Field id="founderBackground" label="Briefly describe your background" required={false}>
                  ...
                  <div className="space-y-4 pt-2">
                    <SectionHeader num="02" title="Startup Overview" points={20} />
                  ...
                  {/* Section 3 */}
                  <div className="space-y-4 pt-2">
                    <SectionHeader num="03" title="Market Opportunity" points={10} />
                    <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  {/* Section 4 */}
                  <div className="space-y-4 pt-2">
                    <SectionHeader num="04" title="Product Status" points={15} />
                  ...
                  {/* Section 5 */}
                  <div className="space-y-4 pt-2">
                    <SectionHeader num="05" title="Customers & Traction" points={15} />
                    <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  {/* Section 6 */}
                  <div className="space-y-4 pt-2">
                    <SectionHeader num="06" title="Business Model" points={10} />
                  ...
                  {/* Section 7 */}
                  <div className="space-y-4 pt-2">
                    <SectionHeader num="07" title="Funding" points={10} />
                    <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  {/* Section 8 */}
                  <div className="space-y-4 pt-2">
                    <SectionHeader num="08" title="Legal & Compliance" points={5} />
                  ...
                  {/* Section 9 */}
                  <div className="space-y-4 pt-2">
                    <SectionHeader num="09" title="Vision" points={10} />
                  ...
                  {/* Documents */}
                  <div className="space-y-4 pt-2">
                    <SectionHeader num="10" title="Documents" points={0} />
                    <div className="grid sm:grid-cols-2 gap-4">
